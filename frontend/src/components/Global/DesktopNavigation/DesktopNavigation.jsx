              ...
              {item?.hasDropdown ? (
                <>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `transition-all duration-200 font-semibold text-base font-['Noto_Sans']  h-full flex gap-[8px] items-center justify-center border-b-[3px] border-b-transparent ${
                        isActive
                ...
                <NavLink
                  to={item?.href}
                  className={({ isActive }) =>
                    `transition-all duration-200 text-base  font-semibold font-['Noto_Sans'] px-[8px] h-full flex items-center justify-center border-b-4 ${
                      isActive
