...
const BooksList = ({ onSectionChange }) => {
  ...
  const getSortedData = () => {
    if (!booksData || !sortConfig.key) return booksData || [];
  ...
  useEffect(() => {
    getBooksData(currentPage - 1, search);
  }, [update]);
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <button
              onClick={() => {
                setSelectedBook(null);
                onSectionChange("createOrEditBook", null);
              }}
          ...
          <TableBody>
            {isLoading ? (
                    ...
                    <div className="flex items-center justify-center gap-2">
                      <button
                        onClick={() => {
                          ...
                          onSectionChange("createOrEditBook", book);
                        }}
              ...
              <TableRow>
                ...
                >
                  {search
                    ? t("No Book found matching your search.")
                    : t("No Book available.")}
                </TableCell>
              </TableRow>
            )}
