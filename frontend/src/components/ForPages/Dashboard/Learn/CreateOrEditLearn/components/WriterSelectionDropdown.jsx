...
/**
 * WriterSelectionDropdown Component
 * Reusable dropdown for selecting a writer
 */
function WriterSelectionDropdown({
  showDropdown,
  onToggleDropdown,
  selectedWriter,
  selectedAvatar,
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        {selectedWriter ? (
          <>
            <img
              src={selectedAvatar || "/fake-user.png"}
              alt={selectedWriter}
              className="w-8 h-8 rounded-full object-cover"
            />
            <div className="flex-1">
              <div className="font-medium text-sm">{selectedWriter}</div>
            </div>
          </>
        ) : (
          <>
...
export default WriterSelectionDropdown;
