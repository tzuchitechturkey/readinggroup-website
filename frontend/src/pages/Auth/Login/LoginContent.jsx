...
function LoginContent() {
  ...
  return (
    <div
      className="w-full flex flex-col relative border-0 outline-none min-h-screen"
      style={{
    ...
    >
      <div className="absolute inset-0 bg-cover bg-center w-full min-h-screen opacity-60 z-0 bg-black" />
        <div className="relative z-1 mt-10 md:mt-16 lg:mt-12">
        <LoginForm />
      </div>
      <div className="flex items-end h-full z-10 mt-10 flex-1">
